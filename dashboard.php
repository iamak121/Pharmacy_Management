...
<body>
            ...
            <?php
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="dashboard.php?id=userProfile">Profile</a>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h1 class="sideber__panel" style="color:black; font-size:2.5rem;"><i id="left"  ></i> PharmaCheck</h1>
            <li id="left" class="sideber__item<?php if ( 'dashboard' == $id ) {
                                                  echo " active";
                                              }?>">
                <a href="pharmacy.html?id=dashboard" style="color:black;"><i id="left" class="fas fa-tachometer-alt"></i>Home</a>
            </li>
            <?php if ( 'admin' == $sessionRole ) {?>
                <!-- Only For Admin -->
                <li id="left" class="sideber__item <?php if ( 'addManager' == $id ) {
                                                                            echo " active";
                                                                        }?>">
                    <a href="dashboard.php?id=addManager"><i id="left" class="fas fa-user-plus"></i></i>Add Manager</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allManager' == $id ) {
    echo " active";
}?>">
                <a href="dashboard.php?id=allManager"><i id="left" class="fas fa-user"></i>All Manager</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addPharmacist' == $id ) {
                    ...
                    <a href="dashboard.php?id=addPharmacist"><i id="left" class="fas fa-user-plus"></i></i>Add
                        Pharmacist</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allPharmacist' == $id ) {
    echo " active";
}?>">
                <a href="dashboard.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>All Pharmacist</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addSalesman' == $id ) {
                    ...
                    <a href="dashboard.php?id=addSalesman"><i id="left" class="fas fa-user-plus"></i>Add Salesman</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allSalesman' == $id ) {
    echo " active";
}?>">
                <a href="dashboard.php?id=allSalesman"><i id="left" class="fas fa-user"></i>All Salesman</a>
            </li>
            <li id="left" class="sideber__item sideber__item--modify<?php if ( 'allSalesman' == $id ) {
    echo " active";
}?>">
                <a href="customer1.php?id=customer"><i id="left" class="fas fa-user"></i>Customer</a>
            </li>
            <li id="left" class="sideber__item<?php if ( 'customer' == $id ) {
    echo " active";
}?>">
                <a href="sample.php?id=allSalesman"><i id="left" class="fas fa-user"></i>Add Customer</a>
            </li>
            <li id="left" class="sideber__item sideber__item--modify<?php if ( 'customer' == $id ) {
    echo " active";
}?>">
                <a href="medicine.php?id=allSalesman"><i id="left" class="fas fa-user"></i>Medicine Record</a>
            </li>
            <li id="left" class="sideber__item<?php if ( 'customer' == $id ) {
    echo " active";
}?>">
                <a href="addmedicine.php?id=allSalesman" class=><i id="left" class="fas fa-user"></i>Add Medicine</a>
            </li>
        </ul>
        <footer class="text-center"><span>PharmaCheck</span><br>©2021 PharmaCheck All right reserved.</footer>
    </section>
                ...
                <div class="dashboard p-5">
                    <div class="total">
                        <div class="row ">
                            ...
                            <div class="col-3">
                                <div class="total__box text-center" style="border-radius:10px;">
                                    <h1>
                                        <?php
                            ...
                            <div class="col-3">
                                <div class="total__box text-center" style="border-radius:10px;">
                                    <h1><?php
                                            $query = "SELECT COUNT(*) totalcustomer FROM customer;";
                                                $result = mysqli_query( $connection, $query );
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <?php if ( 'admin' == $sessionRole ) {?>
                                                <!-- Only For Admin -->
                                                <td><?php printf( "<a href='dashboard.php?action=editManager&id=%s'><i class='fas fa-edit'></i></a>", $manager['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='dashboard.php?action=deleteManager&id=%s'><i class='fas fa-trash'></i></a>", $manager['id'] )?></td>
                                            <?php }?>
                                        </tr>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole ) {?>
                                                <!-- For Admin, Manager -->
                                                <td><?php printf( "<a href='dashboard.php?action=editPharmacist&id=%s'><i class='fas fa-edit'></i></a>", $pharmacist['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='dashboard.php?action=deletePharmacist&id=%s'><i class='fas fa-trash'></i></a>", $pharmacist['id'] )?></td>
                                            <?php }?>
                                        </tr>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                                                ...
                                                <td><?php printf( "<a href='dashboard.php?action=editSalesman&id=%s'><i class='fas fa-edit'></i></a>", $salesman['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='dashboard.php?action=deleteSalesman&id=%s'><i class='fas fa-trash'></i></a>", $salesman['id'] )?></td>
                                            <?php }?>
                                        </tr>
